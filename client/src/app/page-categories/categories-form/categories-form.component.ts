...
import { CategoriesService } from 'src/app/shared/layout/services/categories.service';
...
export class CategoriesFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.isNew) {
      //create
      observableStream$ = this.categoriesService.create(this.form.value.name, this.image)
    } else {
      //update
      observableStream$ = this.categoriesService.update(this.category._id, this.form.value.name, this.image)
    }
